...
# Load the dataset
df = pd.read_csv('balanced_student_health_dataset.csv')
...
joblib.dump(model, 'student_health_risk_model.pkl')
joblib.dump(scaler, 'scaler.pkl')
joblib.dump(label_encoders, 'label_encoders.pkl')

print("\nModel, scaler, and label encoders saved successfully.")

# New version for user input and prediction
...
# Call the function to get user input and predict the risk level
get_user_data_and_predict()
